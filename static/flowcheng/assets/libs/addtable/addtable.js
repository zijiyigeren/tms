    ...
    var orgData = (function () { 
        // console.log('orgData');
        return JSON.parse((localStorage.getItem("userInfo"))).departmentName
        //   var tmp = JSON.parse((localStorage.getItem("userInfo"))).departmentid;
        //   var account = typeof layui.config.getAccount === "function"?layui.config.getAccount():'';
