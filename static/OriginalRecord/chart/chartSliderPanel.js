(function () {
    ...
    function AxisValueEditor(container, data, name, resources, valueChangedCallback, isAxisCategory) {
        ...
        self.maxValueEditor = new InputTextEditor(container, { resources: resources.maxValueText, text: data.maxValue }, function (num) {
            var majorNum = self.valueChanged('max', num);
            self.updateMaxUI(majorNum);
        }, isShowAuto);
        self.minValueEditor = new InputTextEditor(container, { resources: resources.minValueText, text: data.minValue }, function (num) {
        ...
        if (isDateAxis || !isAxisCategory) {
            ...
            self.majorUnitEditor = new InputTextEditor(container, { resources: resources.majorUnitText, text: data.majorUnit, unitScale: data.majorUnitScale }, function (value, isUnitScale) {
            ...
            self.minorUnitEditor = new InputTextEditor(container, { resources: resources.minorUnitText, text: data.minorUnit, unitScale: data.minorUnitScale }, function (value, isUnitScale) {
                if (!isUnitScale) {
            ...
            if (isDateAxis) {
                self.baseUnitEditor = new InputTextEditor(container, { resources: resources.baseUnitText, unitScale: data.baseUnit }, function (value) {
        ...
        if (self.isShowAuto) {
            ...
            if (self.isShowSelect) {
                ...
                selector = $("<select></select>").append(
                    ...
                    "</option><option value= 2>" + designer.res.chartSliderPanel.dateScales.year + "</option>").addClass('select-timeScale-editor').change(function (event) {
