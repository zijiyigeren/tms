                        ...
                        click: function () {
                            ...
                            if (hiddenAndEmptyCellsOptions) {
                                designer.actions.doAction("changeChartElement", designer.wrapper.spread, {
                                    ...
                                    displayNaNAsBlank: hiddenAndEmptyCellsOptions.displayNaNAsBlank,
        ...
        ChartSelectDataDialog.prototype._init = function () {
            ...
            $(".hidden-empty-button").on('click', function () {
                ...
                if (!self._hiddenEmpty) {
                    self._hiddenEmpty = new designer.chartHiddenEmptyCellDialog(function (index, displayNaNAsBlank, showHiddenRowsAndColumnsVal) {
                        self.hiddenAndEmptyCellsOptions = {
                            index: index,
                            displayNaNAsBlank: displayNaNAsBlank,
