(function () {
    ...
    var SpreadStyleShadowObject = (function (_super) {
        ...
        SpreadStyleShadowObject.prototype._getValueCore = function (row, col, propName) {
            ...
            var style = this._sheet.getActualStyle(row, col, undefined, true, undefined, true);
            if (style === undefined || style === null) {
                return undefined;
            }
            if (propName === 'formatter' && style['formatter'] && style['formatter'].formatString) {  // Fix SJS-3588, add the support for GeneralFormatter
                return style['formatter'].formatString();
            }
