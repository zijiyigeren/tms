...
KISBPM.URL = {
    ...
    getUser : function () {
        return ACTIVITI.CONFIG.contextRoot + '/api/member/sys/user';
    },
    //获取角色列表，应用范围：任务受理人编辑和受理组编辑
    getRole : function () {
        return ACTIVITI.CONFIG.contextRoot + '/api/roleManagement/sys/role';
    },
    //根据用户ID获取用户信息，应用范围：任务受理人展示
    getUserById : function (userId) {
        return ACTIVITI.CONFIG.contextRoot + '/api/member/sys/user/' + userId;
    },
    //根据角色ID获取角色信息，应用范围：受理组展示
    getRoleById : function (rId) {
        return ACTIVITI.CONFIG.contextRoot + '/api/roleManagement/sys/role/' + rId;
    },
    ...
    getOrgList : function () {
        return ACTIVITI.CONFIG.contextRoot + '/api/department/sys/org/listOrgByOrgName';
    },
    //根据组织机构ID获得该机构下所有用户列表，应用范围：任务受理人编辑
    getUserByOrgId : function () {
        return ACTIVITI.CONFIG.contextRoot + '/api/department/sys/org/listUserEOByOrgId';
    },
    //获取跳转条件列表
    ...
    getOrgById : function (pid) {
        return ACTIVITI.CONFIG.contextRoot + '/api/department/sys/org/' + pid;
    },
    //获取流程监听
