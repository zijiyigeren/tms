<template>
    <!-- 已办事项 -->
    <div class="alreadydo_border">
        <div class="alreadydo_con">
            <!-- 查询 -->
            ...
            <div class="tablePagination_modular" v-loading="loading" >
                ...
                <div class="table_modular">
                    <el-table border stripe ref="table" :data="tableData"
                        ...
                        <el-table-column align="center" :resizable="false" prop="finishTimeStr" label="任务完成时间"></el-table-column>
