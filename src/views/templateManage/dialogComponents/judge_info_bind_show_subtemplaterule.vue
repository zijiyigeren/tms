...
<script>
    ...
    export default {
        name: 'judge_info_bind_show_subtemplaterule',
        components: {
            JudgeInfoBind,
        },
        props: {
        ...
        methods: {
            ...
            * */
            goBatchDelete () {
                ...
                this.$api.subtemplateRule.deleteBindJudgeInfo(params)
                    .then(res => {
                        this.subIds = []
            ...
            * */
            goBind () {
                this.show3 = true
                this.$nextTick(() => {
                    this.$refs['JudgeInfoBind'].bindIds = [...this.arr1]
            ...
            * */
            GETfn1_bindIds (data) {
                ...
                this.$api.subtemplateRule.addBindJudgeInfo(params)
                    .then(res => {
                        this.goBindJudgeInfoShow(this.rowId)
                        this.show3 = false
                    })
