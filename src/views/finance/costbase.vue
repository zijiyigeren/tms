        ...
        <el-main>
            ...
            <div class="standardCost">
              ...
              <table  border="1" cellspacing="0" cellpadding="0">
                ...
                <tr v-for="(item,index) in standardData" :key="index">
                  ...
                  <td><span @click="newData(false,item)">编辑</span>&nbsp;||&nbsp;<span @click="delData(item)"> 删除</span></td>
                </tr>
              </table>
            </div>
            <div class="standardCost">
              ...
              <table  border="1" cellspacing="0" cellpadding="0">
                ...
                <tr v-for="(item,index) in otherexpenses" :key="index">
                  ...
                  <td>{{item.charges}}</td>
                  <td>{{item.formual}}</td>
                  <td><span @click="newotherexpenses(false,item)">编辑</span>&nbsp;||&nbsp;<span @click="objdelDat(item)"> 删除</span></td>
                </tr>
              </table>
            </div>
          ...
          <el-dialog
            ...
            >
              ...
              <el-form-item label="所需设备" prop="">
                <el-input placeholder="请选择设备"  :readonly="true" v-model="equipmentvalue" disabled="false">
                  <el-button slot="append" icon="el-icon-search" @click="equipmentselection" disabled="false"/>
                </el-input>
              </el-form-item>
            </el-form>
            <hr/>
            ...
            <div class="costlayout">
                <el-form ref="costform" :model="costform" label-width="100px">
                  <el-form-item label="科室名称">
                    <el-input v-model="costform.name"></el-input>
                  </el-form-item>
                  <el-form-item label="试验费用">
                    <el-input v-model="costform.charges"></el-input>
                  </el-form-item>
                  <el-form-item label="打折率">
                    <el-input v-model="costform.discount"></el-input>
                    <br />
              ...
              <div class="costlayout">
                <el-form ref="standardform" :model="otherform" label-width="100px">
                  ...
                  <el-form-item label="单价">
                    <el-input v-model="otherform.charges"></el-input>
                  </el-form-item>
    ...
    methods: {
      ...
      auxiliarystandard(){  // 标准费用插入  辅助费用插入  设备选择插入
        // 标准费用插入
            ...
            this.rejectReport.objectChargeList = this.otherexpenses;
