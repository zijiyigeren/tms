  ...
  <div class="taskallot_box" :style="{ padding: isComing != 0 ? '10px':'0'}">
    <div class="allot" :style="{
      ...
      <el-dialog
        ...
        >
        <div>
         <el-button type="primary" class="bespoke" >在线编辑</el-button>
         <el-button type="primary" class="bespoke" >导入历史原始记录</el-button>
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="popupisible = false">取 消</el-button>
          <el-button type="primary" @click="popupisible = false">确 定</el-button>
        </span>
      </el-dialog>
  ...
  export default {
    ...
    data () {
      return {
        ...
        sing:0,//原始记录上  本地上传记录次数，当次数=上传文件的个数时  弹出成功
        imgFileList:[],//存文件
    ...
    methods: {
      ...
      * */
      ...
      handleExceed (files, fileList) {
        this.$message.warning(`每次最多上传五条数据！`)
      },
      submitUpload() {
