                    ...
                    <ul class="onecB_listcenter" :style="flowColor(item.flowStatus)">
                      <li class="tasknumber2">
                        <el-checkbox v-model=item.checked :label="item" @change="inspectids(item)"
                          v-if="item.process_instance_id != 5 || item.isCurrentPower  == 0 ? false : true"
                      ...
                      <li class="trademark2_4">
                        ...
                        <!-- <el-select v-model="item.inspecopval" placeholder="请选择" class="incolde selwidth"
                                v-if="item.process_instance_id != 5 ? false : true"
                      ...
                      <li class="trademark2_3">
                        <span v-if="item.process_instance_id != 5 || item.isCurrentPower  == 0 ? false : true">{{item.cachetType}}</span>
          ...
          if (data.length == 0) {
            ...
            data.forEach((item, index) => {
              ...
              obj = {
                ...
                ckenck: false,
                clist: item.clist, //图章
                mlist: item.piZhunList, //报告批准人下拉列表
      ...
      handleCheckAllChange (val) {  //全选
        ...
        if (val) {
          ...
          arrTowList.forEach((item, index) => {
            ...
            if(item.process_instance_id == 5 && item.isCurrentPower != 0){
