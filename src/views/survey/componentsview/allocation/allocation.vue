                ...
                <div>
                  <el-table ref="Table2" border v-loading="loading2"
                    ...
                    <!-- <el-table-column prop="assignee" label="检验部科室主任" align="center" :resizable="false">
                      ...
                      <template slot-scope="scope">
                        <el-select
                          ...
                          <el-option
                            v-for="(item,i) in tableData2[scope.$index].zhuRenList"
                            :key="i"
                    ...
                    <el-table-column prop="orgName" label="报告编辑科室" align="center" :resizable="false" >
                      ...
                      <template slot-scope="scope">
                         <span v-if="tableData2[scope.$index].needReport == 0 ? false : true">
                           {{tableData2[scope.$index].orgName}}
                          </span>
                        <!-- <el-select
                          size="mini"
                          style="width:80%;"
    ...
    methods: {
      ...
      * */
      ...
      check(inspectids, musterbs) {
        ...
        console.log(inspectidArry.length)
        console.log(musterbArry.length)
        console.log(this.musterbsnum)
      ...
      onClickXgdReport(row) {
        ...
        // else if(this.selone1 > 0 && this.seltow1 > 0){
        //     if (this.ars == '') {
        //       this.$message.error({message: `请选择科室主任再提交!`, duration: 1500});
        //     }else if(this.offopev == ''){
        //       this.$message.error({message: `请选择编辑科室再提交!`, duration: 1500});
        //     }else if(this.finditingitem == ''){
        //       this.$message.error({message: `请选择编辑人再提交!`, duration: 1500});
        //     }else{
      ...
      obss(obj) {
        this.$api.allot.findJobContent(obj).then(res => {
          ...
          this.tableData2.map(item => {
            ...
            // }
            this.cueeedtin(item.itemsRoom,item) //调取报告编辑人员接口
          });
